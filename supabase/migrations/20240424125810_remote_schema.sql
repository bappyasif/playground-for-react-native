...
COMMENT ON TABLE "public"."order_items" IS 'order items details table';
...
CREATE POLICY "Allow authenticated users to perform all actions" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "all operation are available to authenticated users" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
